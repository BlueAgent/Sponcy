...
public class ItemRegistry {
    public static final ItemDevWand dev_wand = null;
    public static final ItemEnchantedItem enchanted_item = null;
    public static final ItemMendingCharm mending_charm = null;
    public static final ItemShopManager shop_manager = null;
}
